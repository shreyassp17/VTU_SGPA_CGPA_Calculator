...
public class EnterFourthSemMarks extends AppCompatActivity {
    EditText mat,xx42,xx43,xx44,xx45,xx46,xxl47,xxl48,extr,sgpa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enter_fourth_sem_marks);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sub2 = xx42.getText().toString();
                String sub3 = xx43.getText().toString();
                String sub4 = xx44.getText().toString();
                String sub5 = xx45.getText().toString();
                String sub6 = xx46.getText().toString();
                String sub7 = xxl47.getText().toString();
                String sub8 = xxl48.getText().toString();
                ...
                if(sub1.isEmpty() || sub2.isEmpty() || sub3.isEmpty() || sub4.isEmpty() || sub5.isEmpty() || sub6.isEmpty() || sub7.isEmpty() || sub8.isEmpty() || sub9.isEmpty()){
                    Toast.makeText(EnterFourthSemMarks.this, "Please enter marks of all the subjects.", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    subjects.put("SGPA",x);
                    firestore.collection("Scheme2018").document(Uid).collection("Fourth_Sem").document("Subjects").set(subjects).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(EnterFourthSemMarks.this, "Success", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    float calculateSGPA(String sub1,String sub2,String sub3,String sub4,String sub5,String sub6,String sub7,String sub8,String sub9)
    {
        ...
        String[] subjects = {"18MAT41","18XX42","18XX43","19XX44","18XX45","18XX46","18XXL47","18XXL48","18XXX49"};
